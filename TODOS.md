...
## Phase 10 — Dogfooding Sprint (Active)

**Branch**: master | **Mode**: SELECTIVE EXPANSION | **Plan**: `~/.gstack/projects/richardiitse-memory-optimization/ceo-plans/2026-04-22-phase10-dogfooding.md`

### Accepted Scope

| # | Item | Effort | Status |
|---|------|--------|--------|
| Core | 2-week dogfooding sprint with MCP server | M | Pending |
| 1 | BM25 sparse search (rank-bm25 + jieba) | S | Pending |
| 2 | LLM-as-judge eval pipeline (LongMemEval only) | S | Pending |
| 3 | Run kg_extractor on real sessions | M | Pending |

### Deferred

| # | Item | Effort | Reason |
|---|------|--------|--------|
| 4 | KG health monitoring in MCP server | S | 2-week dogfooding doesn't need real-time monitoring |
| 5 | KG import/export for backup/migration | S | `cp graph.jsonl` works; matters for multi-user (Phase 11+) |